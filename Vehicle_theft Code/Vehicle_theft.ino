//code developed by SANAPALA VENKATA RAMANA.
//i clearlly mention the source code how it will be work.
...
void get_gsm() //function for reading GPS data and sending theft location through SMS
{
  ...
  Serial.println("AT+CMGS=\"+919502660428\"\r"); // Replace x with mobile number
  delay(1000);
